...
def test_Password():
    ...
    driver.find_element_by_xpath("//android.widget.EditText[@text='Email']").send_keys("samtest123456@gmail.com")
    driver.find_element_by_xpath("//android.widget.EditText[@text='Password']").send_keys("Qwerty1234")
    ...
    checkPasword = driver.find_element_by_xpath(
            "//android.widget.TextView[@bounds='[80,1298][1360,1357]']").get_attribute("text")

    if checkPasword == "Your confirmation password does not match":
